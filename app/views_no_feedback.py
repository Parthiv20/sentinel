...
def long_task(self):
    ...
    self.update_state(state="PROGRESS", meta={"extent": in_bbox, "type": "vector", "status":"no_feedback"})
...
def taskstatus(task_id):
    ...
    if task.state == 'PENDING':
        ...
        response = {
            ...
            # only for no feedback case. to avoid display overlay mesg in the front end
